...
//   // ✅ Filtering Logic
//   const filtredProblems = problems.filter((problem) => {
...
//             Dive into <span className="font-semibold text-amber-300">{problems.length}</span> problems and sharpen your skills.
//           </p>
//         </div>
