...
const Problem = () => {
    ...
    const renderResultContent = () => {
        ...
        if (isSuccess) { 
            return (
                <div className="space-y-4">
                    <p className="text-green-400 font-bold">🎉 All test cases passed!</p>
                    <p className="text-zinc-400">Test cases passed: {result.testCasesPassed}/{result.testCaseTotal}</p>
                    <p className="text-zinc-400">Runtime: {result.runtime} s</p>
                    <p className="text-zinc-400">Memory: {result.memory} KB</p>
                </div>
            );
        ...
        return (
            <div className="space-y-4">
                <p className="text-red-400 font-bold">❌ {errorMessage}</p>
                <p className="text-zinc-400">Test cases passed: {result.testCasesPassed || 0}/{result.testCaseTotal || 0}</p>
                {result.runtime && <p className="text-zinc-400">Runtime: {result.runtime} s</p>}
                {result.memory && <p className="text-zinc-400">Memory: {result.memory} KB</p>}
            </div>
        );
    };
