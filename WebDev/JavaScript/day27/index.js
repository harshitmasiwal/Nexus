...
form.addEventListener("submit", (e)=> {
    ...
    const fourth_message = victimCardCompliments[Math.floor(Math.random() * 20)]

    const fifth_message = recommendations[(Name.length * SurName.length * Day )%30]

    const sixth_message = predictions[(Day*Month*Year)%20]
